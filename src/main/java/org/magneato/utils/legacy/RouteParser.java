		...
		if (current instanceof Element) {
			...
			if (!value.isEmpty()) {
				...
				if (!data.trim().isEmpty()) {
					...
					case "aspect":
						if (variant) {
							route.addVariant("<strong>Orientation: </strong>"
									+ data + "<br>");
						} else {
					...
					case "description": // ROUTE
						if (variant) {
							route.addVariant("<p><strong>Description:</strong> " + data
									+ "<br>");
						} else {
					...
					case "rating":
						if (variant) {
							route.addVariant("<strong>Rating: </strong>" + data
									+ "<br>");
						}
						break;
					case "risk":
					...
					case "vertical":
						if (variant) {
							route.addVariant("<strong>Vertical: </strong>"
									+ data + "<br>");
						}
						break;
